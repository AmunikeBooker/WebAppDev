...
##                                                 ##
##-------------------------------------------------##
## Copyright = globbersthemes.com- 2016            ##
## Date      = mars 2015                           ##
## Author    = globbers                            ##
...
if($l_=="fr")
$gt='<a target="_blank" href="http://www.globbers.net" title="globbers">globbers</a>&nbsp;<a target="_blank" href="http://www.globbers.net" title="joomla template">joomla templates</a>';
else if($l_=="es")
$gt='<a target="_blank" href="http://www.globbers.net/en" title="globbers">globbers</a>&nbsp;<a target="_blank" href="http://www.globbers.net/en" title="joomla template">joomla template</a>';
else if($l_=="de")
$gt='<a target="_blank" href="http://www.globbers.net/en" title="globbers">globbers</a>&nbsp;<a target="_blank" href="http://www.globbers.net/en" title="joomla template">joomla template</a>';
else 
$gt='<a target="_blank" href="http://www.globbers.net/en" title="globbers">globbers</a>&nbsp;<a target="_blank" href="http://www.globbers.net/en" title="joomla template">joomla template</a>';

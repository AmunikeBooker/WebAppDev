...
<link href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/js/mainmenu/menu-7_boxed.css" rel="stylesheet">
<?php } else { ?>
<link href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/js/mainmenu/menu-7.css" rel="stylesheet">
<?php } ?>
...
{
echo base64_decode('');
}
?>
<?php
if($layout=='boxed')
...
======================================= -->
    <?php
  if($this->countModules('js-slideshow6')) { ?>
    <div class="mstslider">
      <jdoc:include type="modules" name="js-slideshow6" style="nomoduletablediv" />
    </div>
    <?php }  ?>
    <!-- end slider -->

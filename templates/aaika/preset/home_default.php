...
<link href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/js/mainmenu/menu_boxed.css" rel="stylesheet">
<?php } else { ?>
<link href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/js/mainmenu/menu.css" rel="stylesheet">
<?php } ?>
...
{
echo base64_decode('');
}
?>
<?php
if($layout=='boxed')

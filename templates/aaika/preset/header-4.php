...
?>
<link href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/js/mainmenu/bootstrap.min4.css" rel="stylesheet">
<?php 
//  Boxed Layout set by preset
if($layout=='boxed')
{ ?>
<link href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/css/boxed.css" rel="stylesheet">
<link href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/js/mainmenu/menu-5_boxed.css" rel="stylesheet">
<?php } else { ?>
<link href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/js/mainmenu/menu-5.css" rel="stylesheet">
<?php } ?>
...
{
echo base64_decode('');
}
?>
<?php
if($layout=='boxed')
...
?>
  ...
  <div class="site_wrapper">
    ...
    <header id="header" class="<?php echo $innerpages; ?>"> 
            ...
            <div class="container">
              <div class="left"> 
                ...
                <?php
				   ...
				   {
					  ?>
                <a href="index.php" id="logo2"></a>
                <?php } else { ?>
                <a href="index.php"><img src="<?php echo $logo; ?>" alt="logo2"></a>
                <?php } ?>
              </div>
      ...
      <div id="trueHeader">
        <div class="wrapper"> 
          ...
          <div class="container">
            ...
            <?php if($this->countModules('js-search')) { ?>
            <div class="menu_right2">
              <div class="search_hwrap two">
                <jdoc:include type="modules" name="js-search" style="nomoduletablediv" />
              </div>
            </div>
            <?php } ?>
            <!-- end search bar --> 
...
======================================= -->
    <?php
  if($this->countModules('js-slideshow3')) { ?>
    <div class="mstslider two">
      <jdoc:include type="modules" name="js-slideshow3" style="nomoduletablediv" />
    </div>
    <?php }  ?>
    <!-- end slider -->
    ...
    <footer class="footer style3">
      <div class="container">
        <jdoc:include type="modules" name="js-footer2links" style="footer2links" />
        <div class="one_fourth">
          <jdoc:include type="modules" name="js-footer2blog" style="footer2blog" />
          <!-- end footer blogs -->
          <jdoc:include type="modules" name="js-footer2tag" style="footer2tag" />
        </div>
        <!-- end address -->
        
        <div class="one_fourth animate" data-anim-type="fadeInUp" data-anim-delay="300">
          <jdoc:include type="modules" name="js-footer2about" style="footer2about" />
          <jdoc:include type="modules" name="js-footer2tweet" style="nomoduletablediv" />
        </div>
        <!-- end site info -->
        
        <div class="one_fourth last animate" data-anim-type="fadeInUp" data-anim-delay="300">
          <jdoc:include type="modules" name="js-footer2address" style="nomoduletablediv" />
          <jdoc:include type="modules" name="js-footer2contact" style="footer2contact" />
        </div>
        <!-- end about --> 
...
<!-- sticky menu --> 
<script type="text/javascript" src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/js/mainmenu/sticky.js"></script> 

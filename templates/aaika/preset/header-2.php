...
<link href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/js/mainmenu/menu-3_boxed.css" rel="stylesheet">
<?php } else { ?>
<link href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/js/mainmenu/menu-3.css" rel="stylesheet">
<?php } ?>

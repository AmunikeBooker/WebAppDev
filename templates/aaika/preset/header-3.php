...
<link href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/js/mainmenu/menu-4_boxed.css" rel="stylesheet">
<?php } else { ?>
<link href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/js/mainmenu/menu-4.css" rel="stylesheet">
<?php } ?>
        ...
        <div class="wrapper"> 
          ...
          <div class="container">
            ...
            <div class="menu_right2">
              <div class="search_hwrap <?php echo $searchclass; ?>">

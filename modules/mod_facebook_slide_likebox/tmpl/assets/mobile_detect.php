...
class JS_Mobile_Detect
{
    ...
    /**
     * HTTP headers that trigger the 'JSisMobile' detection
     * to be true.
     *
     * @var array
     */
     ...
     * @return bool
     */
    public function JSisMobile($userAgent = null, $httpHeaders = null)
    {
    ...
    public function mobileGrade()
    {
        ...
        if (
            ...
            $this->version('Chrome', self::VERSION_TYPE_FLOAT) >= 16 && !$JSisMobile ||

            // Safari Desktop 5-6 - Tested on OS X 10.7 and Windows 7
            $this->version('Safari', self::VERSION_TYPE_FLOAT) >= 5.0 && !$JSisMobile ||

            // Firefox Desktop 10-18 - Tested on OS X 10.7 and Windows 7
            $this->version('Firefox', self::VERSION_TYPE_FLOAT) >= 10.0 && !$JSisMobile ||

            // Internet Explorer 7-9 - Tested on Windows XP, Vista and 7
            $this->version('IE', self::VERSION_TYPE_FLOAT) >= 7.0 && !$JSisMobile ||

            // Opera Desktop 10-12 - Tested on OS X 10.7 and Windows 7
            $this->version('Opera', self::VERSION_TYPE_FLOAT) >= 10 && !$JSisMobile
        ){
